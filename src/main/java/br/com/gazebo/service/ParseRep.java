...
public class ParseRep {
    public static Map<String, Map<String, Map<String, List<String>>>> parse(String rep){
        Map<String, Map<String, Map<String, List<String>>>> buffer = new HashMap<String, Map<String, Map<String, List<String>>>>();
        ...
        for (String line : reps){
            ...
            if(!buffer.containsKey(pis)){
                buffer.put(pis, new HashMap<String, Map<String, List<String>>>());
            }
            ...
            if(!buffer.get(pis).containsKey(data)){
                buffer.get(pis).put(data, new HashMap<String, List<String>>());
            }
            ...
            if(!buffer.get(pis).get(data).containsKey("horarios")){
                buffer.get(pis).get(data).put("horarios", new ArrayList<String>());
            }
